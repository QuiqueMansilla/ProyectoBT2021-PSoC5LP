// ======================================================================
// Bluetooth2021.v generated from TopDesign.cysch
// 11/17/2021 at 22:25
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("29991338-f163-4500-b5ad-8bb412a06477/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("e7dc75f9-b26e-41f5-90d2-5f30e68ddd17"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__LED_AZUL_net;
	wire [0:0] tmpFB_0__LED_AZUL_net;
	wire [0:0] tmpIO_0__LED_AZUL_net;
	wire [0:0] tmpINTERRUPT_0__LED_AZUL_net;
	electrical [0:0] tmpSIOVREF__LED_AZUL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_AZUL
		 (.oe(tmpOE__LED_AZUL_net),
		  .y({Net_75}),
		  .fb({tmpFB_0__LED_AZUL_net[0:0]}),
		  .io({tmpIO_0__LED_AZUL_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_AZUL_net),
		  .interrupt({tmpINTERRUPT_0__LED_AZUL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_AZUL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
